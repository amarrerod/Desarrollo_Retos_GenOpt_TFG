...
%\begin{figure}[!ht]
%    \centering
%    \includegraphics[scale=0.8]{images/boxplot_CMA_ES_17}
%    \captionsetup{justification=centering}
%    \caption{Comparativa de las instancias CMA\_ES-$\sigma-popsize$ para la función 17.}
%\end{figure}
...
\begin{table}[!ht]
    ...
    \toprule
     \multicolumn{3}{r}{CMA\_ES-$2-50$} & \multicolumn{3}{r}{SA-500} & \multicolumn{3}{r}{OBL-CPSO-75} \\
